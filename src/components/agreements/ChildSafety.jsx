...
import { childSafetyPolicy } from "./childSafetyPolicy";
...
const ChildSafety = () => {
    ...
    return (
        <div className="terms-page terms-only-page">
            ...
            <main className="terms-content">
                ...
                <div className="terms-body">
                    ...
                    <section className="terms-section">
                        <p>
                            <span className="bold-words">Last Updated:</span> 05/12/2025<br />
                            <span className="bold-words">App Name:</span> KalyanaOne<br />
                            <span className="bold-words">Developer:</span> Oztalabs Private Limited<br />
                            <span className="bold-words">Category:</span> Social / Matrimony (Dating – 18+ Only)
                        </p>
                    </section>
                    {childSafetyPolicy.map((sec) => (
                    ...
                    {/* <p>
                        <span className="bold-words">Email:</span>hello@kalyana.one<br />
                        <span className="bold-words">Developer email:</span> hi@ozta.xyz<br />
                        <span className="bold-words">Website:</span> www.kalyana.one<br />
                    </p> */}
