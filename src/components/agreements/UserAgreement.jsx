...
import "./Policy.css";
import { userAgreement, termsAndConditions, privacyPolicy, dataMisuse, disclaimer, guidelines, cookiePolicy } from "./termsOfService";
...
const sidebarTitles = [
    ...
    { id: "data-misuse-clause", title: "Data Misuse Clause" },
...
const UserAgreement = () => {
    ...
    useEffect(() => {
        ...
        if (tab) setActiveSection(tab || 'user-agreement');
    }, [location.search]);
    ...
    const contentData = activeSection === "anti-data-misuse"
        ? dataMisuse
        : activeSection === "disclaimer"
            ? disclaimer
            : activeSection === "community-guidelines"
                ? guidelines
                : activeSection === "cookies-policy"
                    ? cookiePolicy
                    : userAgreement;
